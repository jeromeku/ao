...
def _generate_triton_lut_kernel(name, expr):
    ...
    def {name}_lut_device_kernel(x):
        return {expr}
    """
    return TRITON_LUT_KERNEL_TEMPLATE.format(name=name, expr=expr)
...
def generate_triton_nf4_lut_kernel(use_hardcoded=True, dtype=torch.float32, save_path=None):
    ...
    nf4_lut_expr = _generate_lookup_table(nf4_map)
...
if __name__ == "__main__":
    ...
    print(generate_triton_nf4_lut_kernel(use_hardcoded=True))