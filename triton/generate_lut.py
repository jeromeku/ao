...
@triton.jit
def lut_device_kernel(x):
    return {lookup_statement}
"""

triton_lut_kernel = TRITON_LUT_KERNEL_TEMPLATE.format(lookup_statement=lookup_statement)

print(triton_lut_kernel)
with open("lut_generated.py", "w") as f:
    f.write(triton_lut_kernel)
